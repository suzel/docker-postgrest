...
[![Version](https://img.shields.io/badge/Version-5.2.0-blue.svg)](https://github.com/begriffs/postgrest/tree/master "Version : 5.2.0")
...
cd docker-postgrest/
docker build -t suzel/docker-postgrest --build-arg POSTGREST_VERSION=5.2.0 .
```
